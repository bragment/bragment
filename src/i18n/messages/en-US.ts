export default {
  ...
  'project.getDataSourceStarted': 'Get started by creating a new data source.',
  'project.noDataModels': 'No Data Sources',
  ...
  'workspace.relatedWorkspaces': 'Related Workspaces',
